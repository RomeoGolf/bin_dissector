...
Можно добавить/изменить: ввести защиту от неправильных действий пользователя (закрытие программы в процессе обработки и т. д.), встроить график в окно GUI (?)
...
5. Установить или снять флажок Show array graph - показывать или нет графическое представление массивов в процессе обработки
6. Установить или снять флажок Show variable graph - показывать или нет графическое представление изменение переменных в процессе обработки
7. Открыть файл конфигурации данных (кнопка Open)
8. Установить или снять флажок Use skip, при установленном - выбрать количество пакетов, пропускаемых в начале и конце файла, с учетом отображаемого количества пакетов в файле (packets:)
9. Запустить обработку (кнопка Process). Наблюдать полосу процесса, номер текущего пакета, время прошедшее, оставшееся и ожидаемое. Для отображения номера пакета (packet #:) используется переменная "Npack_" из массива данных. Следует учитывать имя такой переменной при модификации скрипта и использовать счетчик при ее отсутствии.
10. При необходимости в процессе обработки снимать или устанавливать флажок Show graph. Окно графика не закрывать! Снятие флажка (отключение отображения) значительно ускоряет обработку.
11. При необходимости досрочного завершения обработки нажать кнопку Stop.
12. Закрыть окно (кнопка Quit).
